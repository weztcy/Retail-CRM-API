...
src/
  ...
  modules/
    ...
    auth/
      ...
      permission.ts
    customer/
      customer.activity.service.ts
      customer.activity.types.ts
      customer.activity.validation.ts
...
## File: .agents/skills/prisma-cli/references/agent-safety.md
````markdown
...
## File: .agents/skills/prisma-cli/references/complete.md
````markdown
# prisma complete
...
## File: src/app/api/activities/[id]/status/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/customers/[id]/loyalty/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/customers/[id]/restore/route.ts
````typescript
import {
  NextRequest,
} from "next/server";
...
## File: src/app/api/customers/[id]/transactions/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/customers/membership/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/customers/segment/summary/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/customers/segment/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/customers/growth/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/customers/membership/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/customers/top-customers/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/inventory/history/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/inventory/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/loyalty/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/products/low-stock/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/dashboard/top-products/route.ts
````typescript
import {
  successResponse,
  handleError,
...
## File: src/app/api/test-password/route.ts
````typescript
import {
  hashPassword,
  comparePassword,
...
## File: src/app/api/transactions/[id]/status/route.ts
````typescript
import {
  NextRequest,
} from "next/server";
...
## File: src/modules/activity/activity.types.ts
````typescript
...
## File: src/modules/auth/get-current-user.ts
````typescript
import {
  NextRequest,
} from "next/server";
...
## File: src/modules/auth/jwt.utils.ts
````typescript
import {
  SignJWT,
  jwtVerify,
...
## File: src/modules/auth/permission.ts
````typescript
import {
  NextRequest,
} from "next/server";
...
## File: src/modules/customer/customer.activity.service.ts
````typescript
import { prisma } from "@/lib/prisma";
...
## File: src/modules/customer/customer.activity.types.ts
````typescript
...
## File: src/modules/customer/customer.activity.validation.ts
````typescript
import { z } from "zod";
...
## File: src/modules/customer/customer.loyalty.service.ts
````typescript
import { prisma } from "@/lib/prisma";
...
## File: src/modules/customer/customer.segment.service.ts
````typescript
import { prisma } from "@/lib/prisma";
...
## File: src/modules/transaction/transaction.validation.ts
````typescript
import { z } from "zod";
...
## File: src/utils/errors/api-error.ts
````typescript
...
## File: src/validations/test.validation.ts
````typescript
import { z } from "zod";
...
````json
{
  ...
  "skills": {
    ...
    "prisma-compute": {
      ...
      "computedHash": "e5695a3c6f35428e96df30ae662716bd4c9d9074f72cc9334b3050445a1bd4e2"
    },
    "prisma-database-setup": {
      "source": "prisma/skills",
      "sourceType": "github",
...
## File: src/app/api/customers/[id]/activities/route.ts
````typescript
import {
  NextRequest,
} from "next/server";
...
## File: src/modules/customer/customer.types.ts
````typescript
...
## File: src/modules/customer/customer.validation.ts
````typescript
import { z } from "zod";
...
## File: src/modules/product/product.validation.ts
````typescript
import { z } from "zod";
...
================
File: src/modules/activity/activity.validation.ts
================
import { z } from "zod";
...
================
File: src/modules/customer/customer.service.ts
================
import { prisma } from "@/lib/prisma";
...
export const createCustomerSchema = z.object({
  ...
  customerCode: z
    .string()
    .min(3, "Customer code minimal 3 karakter"),
...
================
File: src/modules/product/product.types.ts
================
